...
public enum ClusterTypeEnum {
    ...
    public static ClusterTypeEnum getTypeByCode(String val) {
        for (ClusterTypeEnum type : ClusterTypeEnum.values()) {
            if (type.getCode().equalsIgnoreCase(val)) {
                return type;
            }
        }
        throw new SkyWalkerException("illegal sync clusterType:" + val);
//        return null;
    }
